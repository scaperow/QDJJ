...
namespace Bidserver
{
    ...
    public abstract class SQL
    {
        ...
        public static readonly string connectionString = "Data Source=117.34.66.251,32143;Initial Catalog=QDJJ_TB;User ID=sa;Password=jjrj-13689209960";
        ...
        {
            return ExecuteScalar(SQL.connectionString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(SQL.connectionString, CommandType.StoredProcedure, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(SQL.connectionString, CommandType.Text, cmdText, commandParameters);
        }
