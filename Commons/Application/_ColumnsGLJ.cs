...
namespace GOLDSOFT.QDJJ.COMMONS
{
    ...
    public class _ColumnsGLJ
    {
        ...
        public _ColumnsGLJ()
        {
            ...
            //添加默认创建的列对象
            createDefault("项目名称", _ObjectInfo.FILED_XH, 100, true, false);
            createDefault("类    别", _ObjectInfo.FILED_LB, 100, true, false);
            createDefault("序    号", _ObjectInfo.FILED_XH, 100,true,false);
            createDefault("材机编号", _ObjectInfo.FILED_XMBM, 100, true,false);
            createDefault("名   称", _ObjectInfo.FILED_XMMC, 100, true,true);
            
            createDefault("规格型号", _ObjectInfo.FILED_DW, 100, true,false);
            createDefault("单    位", _ObjectInfo.FILED_TX, 100, true,true);
            createDefault("数    量", _ObjectInfo.FILED_JX, 100, true, true);
            createDefault("定 额 价", _ObjectInfo.FILED_JCBJ, 100, true,true);
            createDefault("市 场 价", _ObjectInfo.FILED_FHBJ, 100, true, true);
            ...
            createDefault("价差合计", _ObjectInfo.FILED_JCHJ, 100, false, FormatType.Numeric);
            createDefault("差价合计", _ObjectInfo.FILED_CJHJ, 100, false, FormatType.Numeric);
            ...
            createDefault("分包金额", _ObjectInfo.FILED_FBJE, 100, true);
