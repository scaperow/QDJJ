...
{
    [Serializable]
    public class _RepairQuantitySource : DataTable
    {
        protected _RepairQuantitySource(SerializationInfo info, StreamingContext context) : base(info, context) { }

        public _RepairQuantitySource()
        {
            this.TableName = "BCRCJ";
            Builder();
        }
