...
{
    [Serializable]
    public class _Measures_Statistics : _Statistics
    {
        ...
        public struct Result
        {
            ...
            public decimal CSAQWM;
            public decimal CSWMSG;
            public decimal CSHJBH;
            public decimal CSLSSS;

            public decimal DEGFHJ;
            public decimal GFHJ;
            public decimal DESJHJ;
            public decimal SJHJ;
            public decimal KCAQWMCSF;
        ...
        {
            _MeasuresProject info = this.Parent as _MeasuresProject;
            foreach (_CommonrojectInfo item in info.CommonrojectList)
            {
        ...
        private void SetHJ()
        {
            ...
            if (info != null)
            {
                ...
                foreach (_CommonrojectInfo item in info.CommonrojectList)
                {
                    ...
                    m_ResultValue.KCAQWMCSF += item.Statistics.ResultVarable.GetDecimal("KCAQWMCSF");
        ...
        {
            m_ResultValue.CSAQWM = (from n in (this.Parent as _MeasuresProject).ObjectsList.Cast<_ObjectInfo>()
                                    where n.XMBM == "C10101"
                                    select n.ZHHJ).Sum();
            m_ResultValue.CSWMSG = (from n in (this.Parent as _MeasuresProject).ObjectsList.Cast<_ObjectInfo>()
                                    where n.XMBM == "1.1"
                                    select n.ZHHJ).Sum();

            m_ResultValue.CSHJBH = (from n in (this.Parent as _MeasuresProject).ObjectsList.Cast<_ObjectInfo>()
                                    where n.XMBM == "1.2"
                                    select n.ZHHJ).Sum();

            m_ResultValue.CSLSSS = (from n in (this.Parent as _MeasuresProject).ObjectsList.Cast<_ObjectInfo>()
                                    where n.XMBM == "1.3"
                                    select n.ZHHJ).Sum();
        ...
        private void doStatistics()
        {
            ...
            this.ResultVarable.Set("CSAQWM", m_ResultValue.CSAQWM);
            this.ResultVarable.Set("CSWMSG", m_ResultValue.CSWMSG);
            this.ResultVarable.Set("CSHJBH", m_ResultValue.CSHJBH);
            this.ResultVarable.Set("CSLSSS", m_ResultValue.CSLSSS);
            this.ResultVarable.Set("KCAQWMCSF", m_ResultValue.KCAQWMCSF);
