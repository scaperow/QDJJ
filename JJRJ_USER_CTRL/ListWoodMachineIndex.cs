...
{
    public partial class ListWoodMachineIndex : BaseControl
    {
        /// <summary>
        /// 当前应用程序目录
        /// </summary>
        ...
        private void Loads()
        {
            if (this.m_CUnitProject != null)
            {
                if (this.m_CUnitProject.Property.Libraries.FixedLibrary.LibraryDataSet != null)
                {
