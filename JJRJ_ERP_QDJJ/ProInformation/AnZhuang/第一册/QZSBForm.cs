...
{
    public partial class QZSBForm : BaseUI
    {
        public QZSBForm()
        {
            InitializeComponent();
        ...
        private void QZSBForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.起重设备;
            this.InfTable.起重设备.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    string strDEWhere = string.Format("LB='起重设备' and FL=',{0},' and GGXH='{1}' ", drCurrent["FL"], drCurrent["GGXH"]);
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            {
                case "FL":
                    this.DQQDDEBindingSource.Filter = " LB = '起重设备'";
                    ...
                    break;
                case "GGXH":
                    this.DQQDDEBindingSource.Filter = string.Format(" LB like '起重设备' and FL like ',{0},' ", currRow["FL"]);
        ...
        private void checkeArr()
        {
            ...
            if (currRow != null)
            {
                ...
                CheckColl.Add("FL");
                //点击确定清单前   判断必填项
                this.DQQDDEBindingSource.Filter = string.Format(" LB = '起重设备' and FL=',{0},' ", currRow["FL"]);
                if (0 < DQQDDEBindingSource.Count)
                {
                    this.DQQDDEBindingSource.Filter = string.Format(" LB = '起重设备' and FL=',{0},' and GGXH is null", currRow["FL"]);
