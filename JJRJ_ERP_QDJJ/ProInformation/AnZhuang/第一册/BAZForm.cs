...
{
    public partial class BAZForm : BaseUI
    {
        public BAZForm()
        {
            InitializeComponent();
        ...
        private void BAZForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.泵安装;
            this.InfTable.泵安装.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    string strDEWhere = string.Format("LB='泵安装' and FL=',{0},'and  GGXH ='{1}' ", drCurrent["FL"], drCurrent["GGXH"]);
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            {
                case "FL":
                    this.DQQDDEBindingSource.Filter = " LB = '泵安装'";
                    ...
                    break;
                case "GGXH":
                    StringBuilder strString = new StringBuilder(" LB = '泵安装'");
                    ...
                    //this.DQQDDEBindingSource.Filter = string.Format(" LB = '泵安装' and FL=',{0},' ", currRow["FL"]);
        ...
        private void checkeArr()
        {
            ...
            if (currRow != null)
            {
                ...
                if (0 < DQQDDEBindingSource.Count)
                {
                    ...
                    this.DQQDDEBindingSource.Filter = string.Format(" LB = '泵安装' and FL=',{0},' and GGXH is null", currRow["FL"]);
