...
{
    public partial class QTJXForm : BaseUI
    {
        public QTJXForm()
        {
            InitializeComponent();
        ...
        private void QTJXForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.其他机械;
            this.InfTable.其他机械.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    string strDEWhere = string.Format("LB='其他机械' and FL=',{0},' and  GGXH ='{1}' ", drCurrent["FL"], drCurrent["GGXH"]);
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            {
                case "FL":
                    this.DQQDDEBindingSource.Filter = " LB = '其他机械'";
                    ...
                    break;
                case "GGXH":
                    this.DQQDDEBindingSource.Filter = string.Format(" LB = '其他机械' and FL=',{0},'", currRow["FL"]);
        ...
        private void checkeArr()
        {
            ...
            if (currRow != null)
            {
                ...
                {
                    this.DQQDDEBindingSource.Filter = string.Format(" LB = '其他机械' and FL=',{0},'  and GGXH is null", currRow["FL"]);
