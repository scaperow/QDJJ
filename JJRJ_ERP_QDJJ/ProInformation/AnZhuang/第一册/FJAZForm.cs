...
{
    public partial class FJAZForm : BaseUI
    {
        public FJAZForm()
        {
            InitializeComponent();
        ...
        private void FJAZForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.风机安装;
            this.InfTable.风机安装.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    string strDEWhere = string.Format("LB='风机安装' and FL=',{0},' and  GGXH ='{1}' ", drCurrent["FL"], drCurrent["GGXH"]);
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            {
                case "FL":
                    this.DQQDDEBindingSource.Filter = " LB = '风机安装'";
                    ...
                    break;
                case "GGXH":
                    this.DQQDDEBindingSource.Filter = string.Format(" LB = '风机安装' and FL=',{0},' ", currRow["FL"]);
        ...
        private void checkeArr()
        {
            ...
            if (currRow != null)
            {
                ...
                {
                    this.DQQDDEBindingSource.Filter = string.Format(" LB = '风机安装' and FL=',{0},' and GGXH is null", currRow["FL"]);
