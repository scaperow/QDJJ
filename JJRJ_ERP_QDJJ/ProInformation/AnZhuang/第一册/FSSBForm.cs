...
{
    public partial class FSSBForm : BaseUI
    {
        public FSSBForm()
        {
            InitializeComponent();
        ...
        private void FSSBForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.附属设备;
            this.InfTable.附属设备.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    StringBuilder strString = new StringBuilder(string.Format("LB = '附属设备' and FL = ',{0},' and  GGXH ='{1}' ", drCurrent["FL"], drCurrent["GGXH"]));
                  
                    string strDEWhere = strString.ToString();//string.Format("LB='附属设备' and FL='{0}' ", drCurrent["FL"]);
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            {
                case "FL":
                    this.DQQDDEBindingSource.Filter = " LB = '附属设备'";
                    ...
                    break;
                case "GGXH":
                    StringBuilder strString = new StringBuilder(" LB = '附属设备'");
                    ...
                    //this.DQQDDEBindingSource.Filter = string.Format(" LB = '附属设备' and FL='{0}'", currRow["FL"]);
                    popControl1.DataSource = RemoveRepeat(DQQDDEBindingSource, "GGXH");
        ...
        private void checkeArr()
        {
            ...
            if (currRow != null)
            {
                ...
                {
                    this.DQQDDEBindingSource.Filter = string.Format(" LB = '附属设备' and FL=',{0},' and GGXH is null", currRow["FL"]);
