...
{
    public partial class HCXForm : BaseUI
    {
        public HCXForm()
        {
            InitializeComponent();
        ...
        private void HCXForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.滑触线;
            this.InfTable.滑触线.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    //string strQDWhere = "ZY='电气' and MC = '滑触线' ";
                    ...
                    //string strDEWhere = string.Format("LB='滑触线' and FL='{0}'  and LX='{1}' and GGXH= '{2}'"
                    //                              , drCurrent["FL"], drCurrent["LX"], drCurrent["GG"]);


                    strString = new StringBuilder("  LB = '滑触线'");
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            switch (e.Column.FieldName)
            {
                case "FL":
                    ...
                    this.DQQDDEBindingSource.Filter = " LB = '滑触线' and FL is not null";
        ...
        private void checkeArr()
        {
            ...
            if (currRow != null)
            {
                ...
                StringBuilder strString = new StringBuilder("  LB = '滑触线'");
                strString.Append(string.IsNullOrEmpty(toString(currRow["FL"])) ? " and FL is null" : string.Format(" and FL like '%,{0},%'", currRow["FL"]));
