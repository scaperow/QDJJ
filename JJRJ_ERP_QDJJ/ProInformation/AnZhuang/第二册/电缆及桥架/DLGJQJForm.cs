...
{
    public partial class DLGJQJForm : BaseUI
    {
        public DLGJQJForm()
        {
            InitializeComponent();
        ...
        private void DLGJQJForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.电缆沟及桥架;
            this.InfTable.电缆沟及桥架.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    strString = new StringBuilder("  LB = '电缆沟及桥架'");
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            switch (e.Column.FieldName)
            {
                case "FL":
                    ...
                    this.DQQDDEBindingSource.Filter = " LB = '电缆沟及桥架' and FL is not null";
                ...
                case "GG":
                    ...
                    popControl1.ColName = new string[] { "分类|GGXH|GG" };
                    popControl1.bind();
                    break;
            }
        }
        ...
        private void checkeArr()
        {
            ...
            if (currRow != null)
            {
                ...
                CheckColl.Add("FL");
                //点击确定清单前   判断必填项 
                this.DQQDDEBindingSource.Filter = " LB = '电缆沟及桥架' ";
                if (0 < DQQDDEBindingSource.Count)
                {
                    this.DQQDDEBindingSource.Filter = " LB = '电缆沟及桥架' and FL is null";
                ...
                StringBuilder strString = new StringBuilder("  LB = '电缆沟及桥架'");
                strString.Append(string.IsNullOrEmpty(toString(currRow["FL"])) ? " and FL is null" : string.Format(" and FL like '%,{0},%'", currRow["FL"]));
