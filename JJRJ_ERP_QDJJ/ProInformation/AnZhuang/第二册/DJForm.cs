...
{
    public partial class DJForm : BaseUI
    {
        public DJForm()
        {
            InitializeComponent();
        ...
        {
            this.bindingSource1.DataSource = InfTable.电机;
            this.InfTable.电机.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    #region 确定清单
                    //string strQDWhere = "ZY='电气' and  MC like  '%,电机,%' ";
                    ...
                    strString = new StringBuilder(" LB = '电机'");
                    strString.Append(string.IsNullOrEmpty(toString(drCurrent["FL"])) ? " and FL is null" : string.Format(" and FL like '%,{0},%'", drCurrent["FL"]))
                             .Append(string.IsNullOrEmpty(toString(drCurrent["GGRLGL"])) ? " and GGXH is null" : string.Format(" and GGXH like '%,{0},%'", drCurrent["GGRLGL"]));
        ...
        protected override void btnRefreshQDMC_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(drCurrent["GGRLGL"].ToString()))
            {
                strContent += "\r\n" + (++i) + ".规格、容量、功率：" + drCurrent["GGRLGL"];
            }
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            switch (e.Column.FieldName)
            {
                ...
                case "GGRLGL":
                    ...
                    popControl1.ColName = new string[] { "分类|GGXH|GGRLGL" };
                    popControl1.bind();
                    break;
            }
        }
        ...
        private void checkeArr()
        {
            ...
            if (currRow != null)
            {
                ...
                CheckColl.Add("FL");
                //点击确定清单前   判断必填项 
                this.DQQDDEBindingSource.Filter = string.Format(" LB = '电机' and FL='{0}'", currRow["FL"]);
                if (0 < DQQDDEBindingSource.Count)
                {
                    this.DQQDDEBindingSource.Filter = string.Format(" LB = '电机' and FL='{0}' and LX is null", currRow["FL"]);
                ...
                if (0 < DQQDDEBindingSource.Count)
                {
                    ...
                    if (1 > DQQDDEBindingSource.Count)
                    {
                        checkMess.Add("规格、容量、功率");
                        CheckColl.Add("GGRLGL");
                    }
                }
