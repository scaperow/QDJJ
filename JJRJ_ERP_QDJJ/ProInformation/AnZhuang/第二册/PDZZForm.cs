...
{
    public partial class PDZZForm : BaseUI
    {
        public PDZZForm()
        {
            InitializeComponent();
        ...
        private void PDZZForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.配电装置;
            this.InfTable.配电装置.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    StringBuilder strString = new StringBuilder(" LB = '配电装置'");
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            switch (e.Column.FieldName)
            {
                case "FL":
                    ...
                    this.DQQDDEBindingSource.Filter = " LB = '配电装置' and FL is not null";
