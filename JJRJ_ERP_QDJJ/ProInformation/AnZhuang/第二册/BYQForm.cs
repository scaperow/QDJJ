...
{
    public partial class BYQForm : BaseUI
    {
        public BYQForm()
        {
            InitializeComponent();
        ...
        private void BYQForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.变压器;
            this.InfTable.变压器.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    StringBuilder strString = new StringBuilder(" LB = '变压器'");
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            switch (e.Column.FieldName)
            {
                case "FL":
                    ...
                    this.DQQDDEBindingSource.Filter = " LB = '变压器' and FL is not null";
