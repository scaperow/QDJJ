...
{
    public partial class DQTZSYForm : BaseUI
    {
        public DQTZSYForm()
        {
            InitializeComponent();
        ...
        private void DQTZSYForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.电气调整试验;
            this.InfTable.电气调整试验.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    strString = new StringBuilder("  LB = '电气调整试验'");
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            switch (e.Column.FieldName)
            {
                case "FL":
                    ...
                    strString = new StringBuilder(" LB = '电气调整试验' and FL is not null");
                    this.DQQDDEBindingSource.Filter = strString.ToString();
        ...
        private void checkeArr()
        {
            ...
            if (currRow != null)
            {
                ...
                CheckColl.Add("FL");
                //点击确定清单前   判断必填项 
                StringBuilder strString = new StringBuilder(" LB = '电气调整试验'");
                this.DQQDDEBindingSource.Filter = strString.ToString();
