...
{
    public partial class KZSBJDYDQForm : BaseUI
    {
        public KZSBJDYDQForm()
        {
            InitializeComponent();
        }

        private void KZSBJDYDQForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.控制设备及低压电器;
            this.InfTable.控制设备及低压电器.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    StringBuilder strString = new StringBuilder(" LB = '控制设备及低压电器'");
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            switch (e.Column.FieldName)
            {
                case "FL":
                    ...
                    this.DQQDDEBindingSource.Filter = " LB = '控制设备及低压电器' and FL is not null";
                ...
                //    this.DQQDDEBindingSource.Filter = string.Format(" LB = '控制设备及低压电器' and FL='{0}'", currRow["FL"]);
                //    popControl1.DataSource = RemoveRepeat(DQQDDEBindingSource, "LX");

                //    popControl1.ColName = new string[] { "分类|LX|LX" };
                //    //清除依赖项数据
                //    popControl1.RemoveDefaultColName = new string[] { "GGXH" };
                //    popControl1.bind();
                //    break;
        ...
        private void checkeArr()
        {
            ...
            if (currRow != null)
            {
                ...
                //{
                //    this.DQQDDEBindingSource.Filter = string.Format(" LB = '控制设备及低压电器' and FL='{0}' and LX is null", currRow["FL"]);
