...
{
    public partial class XDCForm : BaseUI
    {
        public XDCForm()
        {
            InitializeComponent();
        ...
        private void XDCForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.蓄电池;
            this.InfTable.蓄电池.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    #region 确定清单
                    string strQDWhere = "ZY='电气' and  MC like  '%,蓄电池,%'";
                    ...
                    //有疑惑 //有疑惑 //有疑惑 //有疑惑 //有疑惑 //有疑惑 //有疑惑 //有疑惑 //有疑惑 //有疑惑 //有疑惑 //有疑惑

                    //string strDEWhere = string.Format("LB='蓄电池' and FL='{0}' and GGXH= '{1}'"
                    //                              , drCurrent["FL"], drCurrent["RL"]);

                    StringBuilder strString = new StringBuilder(" LB = '蓄电池'");
                    strString.Append(string.IsNullOrEmpty(toString(drCurrent["FL"])) ? " and FL is null" : string.Format(" and FL like '%,{0},%'", drCurrent["FL"]))
                             .Append(string.IsNullOrEmpty(toString(drCurrent["RL"])) ? " and GGXH is null" : string.Format(" and GGXH like '%,{0},%'", drCurrent["RL"]));
        ...
        protected override void btnRefreshQDMC_Click(object sender, EventArgs e)
        {
            ...
            {
                strContent += "\r\n" + (++i) + ".蓄电池分类：" + drCurrent["FL"];
            }
            if (!string.IsNullOrEmpty(drCurrent["RL"].ToString()))
            {
                strContent += "\r\n" + (++i) + ".容量：" + drCurrent["RL"];
            }
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            switch (e.Column.FieldName)
            {
                ...
                case "RL":
                    ...
                    popControl1.ColName = new string[] { "分类|GGXH|RL" };
                    popControl1.bind();
                    break;
            }
        }
        ...
        private void checkeArr()
        {
            ...
            if (currRow != null)
            {
                ...
                {
                    this.DQQDDEBindingSource.Filter = " LB = '蓄电池' and FL is null";
