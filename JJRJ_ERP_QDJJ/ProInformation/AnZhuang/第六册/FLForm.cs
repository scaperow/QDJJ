...
{
    public partial class FLForm : BaseUI
    {
        public FLForm()
        {
            InitializeComponent();
        ...
        private void FLForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.法兰;
            this.InfTable.法兰.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    if (gczj != -1)
                    {
                        strString = new StringBuilder(" BWLB ='保温层' and BWFL ='法兰' ");
                    ...
                    #region 工业管道确定定额
                    strString = new StringBuilder(" LB='法兰' ");
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            {
                case "FL":
                    strString = new StringBuilder(" LB='法兰' and FL is not null");
                    GYGDQDDEBindingSource.Filter = strString.ToString();
                ...
                case "CZ":
                    ...
                    strString = new StringBuilder(" LB='法兰' and CZ is not null");
                ...
                case "LJFS":
                    ...
                    strString = new StringBuilder(" LB='法兰' and LJFS is not null");
                    strString.Append(string.IsNullOrEmpty(toString(currRow["FL"])) ? " and FL is null" : string.Format(" and  FL = '{0}'", currRow["FL"]))
                ...
                case "GJ":
                    ...
                    strString = new StringBuilder(" LB='法兰' and GJ is not null");
                    strString.Append(string.IsNullOrEmpty(toString(currRow["FL"])) ? " and  FL is null" : string.Format(" and  FL = '{0}'", currRow["FL"]))
                             .Append(string.IsNullOrEmpty(toString(currRow["CZ"])) ? " and  CZ is null" : string.Format("  and CZ = '{0}'", currRow["CZ"]))
                ...
                case "BWQFFSYYQ":
                    ...
                    break;
                case "BWJRCLZL":
                    this.BWJRGCBindingSource.Filter = string.Format("FL ='保温绝热工程' and BWLB ='保温层' and BWFL='法兰' and JRCL is not null");
                ...
                case "BWHD":
                    ...
                    strString = new StringBuilder("FL='保温绝热工程' and BWLB ='保温层' and BWFL ='法兰' and JRHD is not null");
        ...
        private void checkeArr()
        {
            ...
            if (currRow != null)
            {
                ...
                checkMess.Add("材质");
                CheckColl.Add("CZ");
                StringBuilder strString = new StringBuilder(" LB='阀门' ");
                strString.Append(string.IsNullOrEmpty(toString(currRow["FL"])) ? " and FL is null" : string.Format(" and  FL = '{0}'", currRow["FL"]))
                         .Append(string.IsNullOrEmpty(toString(currRow["CZ"])) ? " and  CZ is null" : string.Format("  and CZ = '{0}'", currRow["CZ"]));
