...
{
    public partial class FMForm : BaseUI
    {
        public FMForm()
        {
            InitializeComponent();
        ...
        {
            this.bindingSource1.DataSource = InfTable.阀门;
            this.InfTable.阀门.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    if (gczj != -1)
                    {
                        strString = new StringBuilder(" BWLB ='保温层' and BWFL ='阀门' ");
                    ...
                    #region 工业管道确定定额
                    strString = new StringBuilder(" LB='阀门' ");
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            {
                case "FL":
                    strString = new StringBuilder(" LB='阀门' and FL is not null");
                    GYGDQDDEBindingSource.Filter = strString.ToString();
                ...
                case "CZ":
                    ...
                    strString = new StringBuilder(" LB='阀门' and CZ is not null");
                ...
                case "LJFS":
                    ...
                    strString = new StringBuilder(" LB='阀门' and LJFS is not null");
                    strString.Append(string.IsNullOrEmpty(toString(currRow["FL"])) ? " and FL is null" : string.Format(" and  FL = '{0}'", currRow["FL"]))
                ...
                case "GJ":
                    ...
                    strString = new StringBuilder(" LB='阀门' and GJ is not null");
                    strString.Append(string.IsNullOrEmpty(toString(currRow["FL"])) ? " and  FL is null" : string.Format(" and  FL = '{0}'", currRow["FL"]))
                             .Append(string.IsNullOrEmpty(toString(currRow["CZ"])) ? " and  CZ is null" : string.Format("  and CZ = '{0}'", currRow["CZ"]))
                ...
                case "BWQFFSYYQ":
                    ...
                    break;
                case "BWJRCLZL":
                    this.BWJRGCBindingSource.Filter = string.Format("FL ='保温绝热工程' and BWLB ='保温层' and BWFL='阀门' and JRCL is not null");
                ...
                case "BWHD":
                    ...
                    strString = new StringBuilder("FL='保温绝热工程' and BWLB ='保温层' and BWFL ='阀门' and JRHD is not null");
