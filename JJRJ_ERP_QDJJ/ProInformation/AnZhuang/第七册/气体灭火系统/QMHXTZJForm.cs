...
{
    public partial class QMHXTZJForm : BaseUI
    {
        public QMHXTZJForm()
        {
            InitializeComponent();
        ...
        private void QMHXTZJForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.气灭火系统组件;
            this.InfTable.气灭火系统组件.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        protected override void btnRefreshQDMC_Click(object sender, EventArgs e)
        {
            ...
            {
                strContent += "\r\n" + (++i) + ".气体灭火系统组件材质、类型：" + drCurrent["CZLX"];
            }
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            switch (e.Column.FieldName)
            {
                case "CZLX":
                    ...
                    this.XTZJBindingSource.Filter = " XT='气体灭火' and CZLX is not null";
                    //字符串截断并去重复
                    popControl1.DataSource = RemoveRepeat(this.XTZJBindingSource, "CZLX");

                    popControl1.ColName = new string[] { "材质、类型|CZLX|CZLX" };
                    popControl1.RemoveDefaultColName = new string[] { "LJFS", "GGXH" };
                    popControl1.bind();
                    break;
                case "LJFS":
                    ...
                    popControl1.DataSource = RemoveRepeat(XTZJBindingSource, "LJFS");
