...
{
    public partial class RQGDFJForm : BaseUI
    {
        public RQGDFJForm()
        {
            InitializeComponent();
        ...
        private void RQGDFJForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        public override object Parm
        {
            ...
            set
            {
                ...
                ArrCheckMess = new string[] { "管道附件名称", "规格" };
                ArrCheckColl = new string[] { "GDFJMC", "GG" };
                base.Parm = value;
        ...
        {
            this.bindingSource1.DataSource = InfTable.燃气管道附件;
            this.InfTable.燃气管道附件.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    #region 确定清单
                    string strQDWhere = string.Format("CZ like '%,{0},%'", toString(drCurrent["GDFJMC"]));
                    ...
                    string strDEWhere = string.Format("FL='管道附件' and YT='{0}' and GG= '{1}'", drCurrent["GDFJMC"], drCurrent["GG"]);
        ...
        protected override void btnRefreshQDMC_Click(object sender, EventArgs e)
        {
            ...
            int i = 0;
            if (!string.IsNullOrEmpty(drCurrent["GDFJMC"].ToString()))
            {
                strContent += "\r\n" + (++i) + ".管道附件名称：" + drCurrent["GDFJMC"];
            }
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            switch (e.Column.FieldName)
            {
                case "GDFJMC":
                    ...
                    RQGDBindingSource.Filter = " FL = '管道附件'";
                    popControl1.DataSource = RemoveRepeat(RQGDBindingSource, "YT");

                    popControl1.ColName = new string[] { "分类|YT|GDFJMC" };
                    //清除依赖项数据
                ...
                case "GG":
                    ...
                    this.RQGDBindingSource.Filter = string.Format(" FL='管道附件' and YT='{0}' ", toString(currRow["GDFJMC"]));

                    popControl1.ColName = new string[] { "分类|GG|GG" };
                    popControl1.bind();
                    break;
                case "AZGD":
