...
{
    public partial class RQBForm : BaseUI
    {
        public RQBForm()
        {
            InitializeComponent();
        ...
        private void RQBForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.燃气表;
            this.InfTable.燃气表.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    string strDEWhere = string.Format("FL='燃气表' and YT='{0}' and GG= '{1}'", drCurrent["SYFW"], drCurrent["GGXH"]);
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            switch (e.Column.FieldName)
            {
                case "SYFW":
                    ...
                    RQGDBindingSource.Filter = " FL = '燃气表'";
                ...
                case "GGXH":
                    ...
                    this.RQGDBindingSource.Filter = string.Format(" FL='燃气表' and YT='{0}' ", toString(currRow["SYFW"]));
