...
{
    public partial class RQZJForm : BaseUI
    {
        public RQZJForm()
        {
            InitializeComponent();
        ...
        private void RQZJForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        public override object Parm
        {
            ...
            set
            {
                ...
                ArrCheckMess = new string[] { "使用范围", "规格、型号" };
                ArrCheckColl = new string[] { "SYFW", "GGXH" };
                base.Parm = value;
        ...
        {
            this.bindingSource1.DataSource = InfTable.燃气灶具;
            this.InfTable.燃气灶具.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    #region 确定清单
                    string strQDWhere = string.Format("CZ like '%,{0},%'", toString(drCurrent["SYFW"]));
                    ...
                    string strDEWhere = string.Format("FL='然气灶具' and YT='{0}' and GG= '{1}'", drCurrent["SYFW"], drCurrent["GGXH"]);
        ...
        protected override void btnRefreshQDMC_Click(object sender, EventArgs e)
        {
            ...
            int i = 0;
            if (!string.IsNullOrEmpty(drCurrent["SYFW"].ToString()))
            {
                strContent += "\r\n" + (++i) + ".然气灶具使用范围：" + drCurrent["SYFW"];
            }
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            switch (e.Column.FieldName)
            {
                case "SYFW":
                    ...
                    RQGDBindingSource.Filter = " FL = '然气灶具'";
                    popControl1.DataSource = RemoveRepeat(RQGDBindingSource, "YT");

                    popControl1.ColName = new string[] { "分类|YT|SYFW" };
                    //清除依赖项数据
                ...
                case "GGXH":
                    ...
                    this.RQGDBindingSource.Filter = string.Format(" FL='然气灶具' and YT='{0}' ", toString(currRow["SYFW"]));
                    popControl1.DataSource = RemoveRepeat(RQGDBindingSource,"GG");
