...
{
    public partial class RQJRSBForm : BaseUI
    {
        public RQJRSBForm()
        {
            InitializeComponent();
        ...
        private void RQJRSBForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        public override object Parm
        {
            ...
            set
            {
                ...
                ArrCheckMess = new string[] { "功能、用途", "规格、型号" };
                ArrCheckColl = new string[] { "GNYT", "GGXH" };
                base.Parm = value;
        ...
        {
            this.bindingSource1.DataSource = InfTable.燃气加热设备;
            this.InfTable.燃气加热设备.RowChanged += new DataRowChangeEventHandler(this.RowChanged);

            this.RQGDBindingSource.DataSource = APP.Application.Global.DataTamp.安装专业工程信息表.Tables["燃气管道"];
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    #region 确定清单
                    string strQDWhere = string.Format("CZ like '%,{0},%'", toString(drCurrent["GNYT"]));
                    ...
                    string strDEWhere = string.Format("FL='燃气加热设备' and YT='{0}' and GG= '{1}'", drCurrent["GNYT"], drCurrent["GGXH"]);

                    this.RQGDBindingSource.Filter = strDEWhere;

                    foreach (DataRowView item in this.RQGDBindingSource)
                    {
        ...
        protected override void btnRefreshQDMC_Click(object sender, EventArgs e)
        {
            ...
            int i = 0;
            if (!string.IsNullOrEmpty(drCurrent["GNYT"].ToString()))
            {
                strContent += "\r\n" + (++i) + ".燃气加热设备功能、用途：" + drCurrent["GNYT"];
            }
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            switch (e.Column.FieldName)
            {
                case "GNYT":
                    ...
                    RQGDBindingSource.Filter = " FL = '燃气加热设备'";
                    popControl1.DataSource = RemoveRepeat(RQGDBindingSource, "YT");

                    popControl1.ColName = new string[] { "分类|YT|GNYT" };
                    //清除依赖项数据
                ...
                case "GGXH":
                    ...
                    popControl1.DataSource = this.RQGDBindingSource;
                    this.RQGDBindingSource.Filter = string.Format(" FL='燃气加热设备' and YT='{0}' ", toString(currRow["GNYT"]));

                    popControl1.ColName = new string[] { "分类|GG|GGXH" };
                    popControl1.bind();
                    break;
                case "AZGD":
