...
{
    public partial class SLJCJForm : BaseUI
    {
        public SLJCJForm()
        {
            InitializeComponent();
        ...
        private void SLJCJForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        ...
        {
            this.bindingSource1.DataSource = InfTable.塑料检查井;
            this.InfTable.塑料检查井.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    string strDEWhere = string.Format(" FL ='{0}' and GGXH='{1}'", drCurrent["FL"], drCurrent["GGXH"]);
