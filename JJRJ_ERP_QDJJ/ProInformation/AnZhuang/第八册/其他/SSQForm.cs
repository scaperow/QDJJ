...
{
    public partial class SSQForm : BaseUI
    {
        public SSQForm()
        {
            InitializeComponent();
        ...
        private void SSQForm_Load(object sender, EventArgs e)
        {
            OnlyOneDataSource();
        }
        public override object Parm
        {
            ...
            set
            {
                ...
                ArrCheckMess = new string[] { "连接方式", "规格、型号" };
                ArrCheckColl = new string[] { "LJFS","GGXH" };
                base.Parm = value;
        ...
        {
            this.bindingSource1.DataSource = InfTable.伸缩器;
            this.InfTable.伸缩器.RowChanged += new DataRowChangeEventHandler(this.RowChanged);
        ...
        private void ScreenWDBH(bool isAdd)
        {
            try
            {
                ...
                if (isAdd)
                {
                    ...
                    string strDEWhere = string.Format(" FL ='伸缩器' and TGCZ='{0}' and GGXH='{1}' ", drCurrent["LJFS"], drCurrent["GGXH"]);
        ...
        private void gridView1_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            ...
            switch (e.Column.FieldName)
            {
                case "LJFS":
                    ...
                    this.QTGPSQDDEBindingSource.Filter = " FL='伸缩器'";
                    popControl1.DataSource = RemoveRepeat(QTGPSQDDEBindingSource, "TGCZ");

                    popControl1.ColName = new string[] { "分类|TGCZ|LJFS" };
                    popControl1.RemoveDefaultColName = new string[] { "GGXH" };
                    popControl1.bind();
                    break;
                case "GGXH":

                    this.QTGPSQDDEBindingSource.Filter = string.Format(" FL = '伸缩器' and TGCZ ='{0}'", currRow["LJFS"]);
