...
namespace GOLDSOFT.QDJJ.UI
{
    ...
    /// 报表界面
    /// </summary>
    public partial class ProReportForm : ABaseForm
    {
        ...
        public override void Init()
        {
            ...
            if (this.CurrentBusiness.Current != null)
            {
                FillInfo();
        ...
        {
            m_Report.StructSource = this.CurrentBusiness.Current.StructSource;
            m_Report.CurrBusiness = this.CurrentBusiness;
        ...
        {
            m_Report = new GLODSOFT.QDJJ.BUSINESS._ProjectsReport();
        ...
        private void treeList_FocusedNodeChanged(object sender, FocusedNodeChangedEventArgs e)
        {
            ...
            if (m_TreeList != null)
            {
                ...
                if (bs != null)
                {
                    if (bs.GetType() == typeof(NodeReport))
                    {
