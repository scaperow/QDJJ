...
{
    public partial class OpenTBBS : CBaseForm
    {
        ...
        private void Commit()
        {
            if (this.buttonEdit1.Text != string.Empty)
            {
                ...
                {
                    case GOLDSOFT.QDJJ.COMMONS._Files.CFileType.调标文件:
        ...
        /// <param name="e"></param>
        private void OpenTBBS_Load(object sender, EventArgs e)
        {
            //this.openFileDialog1.Filter = "全部文件|*.*|项目文件|*.jxmx|工程文件|*.jgcx|TBS文件|*.tbs|ZBS文件|*.zbs|电子标书|*.JZBX";
            this.openFileDialog1.Filter = "调标文件|*.tbx";
        }
        ...
        private void Opear()
        {
            ...
            //        MsgBox.Show("该文件为专业信息文件，请在专业信息中打开", MessageBoxButtons.OK);
            //        break;
            //    default://不做任何操作
