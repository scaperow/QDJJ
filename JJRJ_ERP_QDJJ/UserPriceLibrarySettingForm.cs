...
{
    public partial class UserPriceLibrarySettingForm : BaseForm
    {
        /// <summary>
        /// 当前选中行
        /// </summary>
        ...
        public UserPriceLibrarySettingForm()
        {
            InitializeComponent();
        }

        private void UserPriceLibrarySettingForm_Load(object sender, EventArgs e)
        {
        ...
        private void gridView1_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            if (e.Column.FieldName == "XZ")
            {
                ...
                DataRow[] xz = APP.UserPriceLibrary.UserPriceLibrarySource.Select("XZ='True'");
                if (xz.Count() != 0)
                {
